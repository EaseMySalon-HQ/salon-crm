...
const FEATURE_ROUTE_RULES = [
  ...
  },
  {
    ...
    pathPattern: /^\/api\/leads(\/|$)/,
    description: 'Tenant lead CRM — list, create, update, convert, and delete',
  },
  {
    feature: FEATURE.MEMBERSHIP,
    methods: ['GET', 'POST', 'PUT', 'PATCH'],
    pathPattern: /^\/api\/membership(\/|$)/,
    description: 'Membership plans, subscriptions, and redemption',
  },
  {
    feature: FEATURE.PACKAGES,
    methods: ['GET', 'POST', 'PUT', 'PATCH', 'DELETE'],
    pathPattern: /^\/api\/packages(\/|$)/,
    description: 'Package catalog, sales, client packages, and reports',
  },
  {
    feature: FEATURE.PREPAID_WALLET,
    methods: ['GET', 'POST', 'PUT', 'PATCH'],
    pathPattern: /^\/api\/client-wallet(\/|$)/,
    description: 'Client prepaid wallet plans, balances, and redemption',
  },
  {
